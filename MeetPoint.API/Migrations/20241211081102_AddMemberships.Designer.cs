...
namespace MeetPoint.API.Migrations
{
    ...
    [Migration("20241211081102_AddMemberships")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MeetPoint.API.Database.Entities.MembershipEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MeetPoint.API.Database.Entities.RatingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("MeetPoint.API.Database.Entities.CommentEntity", b =>
                {
                    ...
                    b.HasOne("MeetPoint.API.Database.Entities.CommentEntity", "ParentComment")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("MeetPoint.API.Database.Entities.MembershipEntity", b =>
                {
                    ...
                    b.HasOne("MeetPoint.API.Database.Entities.UserEntity", "User")
                        .WithOne("Membership")
                        .HasForeignKey("MeetPoint.API.Database.Entities.MembershipEntity", "UserId");
            ...
            modelBuilder.Entity("MeetPoint.API.Database.Entities.RatingEntity", b =>
                {
                    ...
                    b.HasOne("MeetPoint.API.Database.Entities.UserEntity", "Rater")
                        .WithMany("MadeRatings")
